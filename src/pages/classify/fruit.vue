<template>
	<div class="class_hot2">
		...
		<nav class="hot2_nav">
			<ul>
				<li @click="curr=0"><a href="javascript:;" :class="{active:curr==0}">时令爆款</a></li>
				<li @click="curr=1"><a href="javascript:;" :class="{active:curr==1}">今日必买</a></li>
				<li @click="curr=2"><a href="javascript:;" :class="{active:curr==2}">本周上新</a></li>
				<li @click="curr=3"><a href="javascript:;" :class="{active:curr==3}">提子圣女果</a></li>
				<li @click="curr=4"><a href="javascript:;" :class="{active:curr==4}">热带水果</a></li>
				<li @click="curr=5"><a href="javascript:;" :class="{active:curr==5}">奇异果</a></li>
				<li @click="curr=6"><a href="javascript:;" :class="{active:curr==6}">苹果梨</a></li>
			</ul>
		</nav>
		<section class="proList">
			<div class="pro" v-for="(item,index) in pro" :key="index" v-show="index>=20 && index<=24">
